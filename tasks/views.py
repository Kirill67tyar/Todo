...
class TaskListView(LoginRequiredMixin, ListView):
    ...
    def get_queryset(self):
        u = self.request.user   # если user не аутентифицирован, то в request будет AnonymousUser
...
class TaskDetailView(LoginRequiredMixin, DetailView):
    ...
    def get_context_data(self, **kwargs):
        ...
        # user_task = models.TodoItem.objects.get(owner=u, pk=self.kwargs['pk'])
        # print(f'\n\n:::::::::::::::::::::::::::::::::::::::::::::::::::::\n'
...
def index(request):
    ...
    #[# annotate - как-бы позволяет определить, какую переменную подсчета ты будешь использовать] - под большим вопросом
